...
urlpatterns = [
    url(r'^endscore/$',game.views.endscore,name='endscore'),
    ...
    url(r'^cda/$', game.views.cda, name='cda'),
    url(r'^placements/$', game.views.placements, name='placements'),
    url(r'^oasis/$', game.views.oasis, name='oasis'),
    url(r'^bosm/$', game.views.bosm, name='bosm'),
