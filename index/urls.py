...
urlpatterns = [
    ...
    url(r'^cda/$', game.views.Acads, name='cda'),
    url(r'^placements/$', game.views.Acads, name='placements'),
    url(r'^oasis/$', game.views.Acads, name='oasis'),
    url(r'^bosm/$', game.views.Acads, name='bosm'),
