...
urlpatterns = [
    ...
    url(r'^cda/$', game.views.Acads, name='Acads'),
    url(r'^placements/$', game.views.Acads, name='Acads'),
    url(r'^oasis/$', game.views.Acads, name='Acads'),
    url(r'^bosm/$', game.views.Acads, name='Acads'),
